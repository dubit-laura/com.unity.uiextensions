    ...
    public class SegmentedControl : UIBehaviour
    {
        ...
        public int selectedSegmentIndex
        {
            ...
            set
            {
                ...
                if (selectedSegment)
                {
                    var segment = selectedSegment.GetComponent<UnityEngine.UI.Extensions.Segment>();
                    if (segment)
                    {
        ...
        private Selectable[] GetChildSegments()
        {
            ...
            {
                var segment = buttons[i].GetComponent<UnityEngine.UI.Extensions.Segment>();
                if (segment != null)
                {
                    segment.index = i;
        ...
        private void RecreateSprites()
        {
            for (int i = 0; i < segments.Length; i++)
            {
                ...
                var segment = segments[i].GetComponent<UnityEngine.UI.Extensions.Segment>();
                if (segment)
                {
